...
/// collide on `a.png`).
#[test]
#[ignore = "known bug 2: with_extension truncates labels at the last dot"]
...
#[test]
#[ignore = "known bug 3: dedup suffix collides with multi-image numbering"]
...
#[test]
#[ignore = "known bug 9: empty label writes <output_dir>.png beside the output dir"]
...
#[test]
#[ignore = "known bug 10: explicit label collides with a dedup-generated name"]
